...
- `docs/current/SUNO_STUDIO_FEATURE_GUIDE.md` — detailed feature/API说明
- `docs/current/SUNO_STUDIO_OPERATIONS_RUNBOOK.md` — detailed运维、验收、备份和回滚
...
Stems and durable Studio state. The build is inside the image; host `.next` is not mounted.
